          ...
          <div className="space-y-4">
            ...
            {project.problem && project.solution && project.result && (
              <div className="grid grid-cols-1 gap-3.5 border-t border-slate-800 pt-4">
                ...
                <div className="space-y-1 bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            {project.demoUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold rounded-lg text-xs tracking-wide uppercase transition-all flex items-center gap-2"
              >
